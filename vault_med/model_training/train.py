...
train_features=np.load(f"{PARENT_DIR}/feature_extraction/data/train_features.npy")
train_labels=np.load(f"{PARENT_DIR}/feature_extraction/data/train_labels.npy")
